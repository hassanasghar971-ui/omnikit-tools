...
import { LT } from "@/components/localized";
      ...
      <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_300px]">
        <div className="min-w-0">
          <nav aria-label="Breadcrumb" className="mb-3 flex flex-wrap items-center gap-1.5 text-xs text-slate-500">
            <Link href="/" className="hover:text-cyan-300"><LT k="breadcrumb.home" /></Link>
            <span>/</span>
            <Link href="/tools" className="hover:text-cyan-300"><LT k="breadcrumb.tools" /></Link>
            <span>/</span>
          ...
          <div className="mb-5 flex flex-wrap items-center gap-3">
            ...
            <span className={`rounded-full border px-2.5 py-1 text-[11px] font-medium ${isNew ? "border-emerald-500/30 bg-emerald-500/10 text-emerald-300" : "border-cyan-500/30 bg-cyan-500/10 text-cyan-300"}`}>
              {isNew ? <>● <LT k="tool.new" /></> : <>◆ <LT k="tool.offline" /></>}
            </span>
          </div>
          ...
          <section className="mt-10">
            <h2 className="mb-4 text-xl font-bold tracking-tight text-white"><LT k="tool.guide" /></h2>
          ...
          <section className="mt-10">
            <h2 className="mb-4 text-xl font-bold tracking-tight text-white"><LT k="tool.faqs" /></h2>
          ...
          <section className="mt-10">
            <h2 className="mb-4 text-xl font-bold tracking-tight text-white">
              <LT k="tool.related" vars={{ category: category.name }} />
            </h2>
        ...
        <aside className="hidden space-y-5 xl:block">
          <div className="sticky top-24 space-y-5">
            ...
            <section className="rounded-2xl border border-white/10 bg-white/[0.02] p-5">
              <h3 className="mb-3 text-xs font-semibold uppercase tracking-[0.2em] text-slate-400"><LT k="tool.usecases" /></h3>
            ...
            <section className="rounded-2xl border border-white/10 bg-white/[0.02] p-5">
              <h3 className="mb-3 text-xs font-semibold uppercase tracking-[0.2em] text-slate-400"><LT k="tool.trust" /></h3>
