    ...
    <div className="space-y-4">
      <Panel className="border-cyan-500/20 bg-cyan-500/[0.04] p-4">
        <p className="text-sm leading-relaxed text-slate-300">
          <span className="font-semibold text-cyan-300">{tool.name}</span> is in the release pipeline of the OmniKit registry.
          Until its dedicated processor ships, this premium workspace handles your data fully on-device — zero uploads, zero retention.
        </p>
      </Panel>
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="space-y-2">
