...
import { LOCALE_NAMES, LOCALES } from "@/lib/locale-meta";
          ...
          <div className="relative">
            ...
            {langOpen ? (
              <>
                ...
                <div className="lang-pop absolute end-0 z-20 mt-2 max-h-[70vh] w-44 overflow-y-auto rounded-xl border border-white/10 bg-[#0a1120] py-1 shadow-2xl">
                  {LOCALES.map((l) => (
                    <button
                      key={l}
                      onClick={() => {
