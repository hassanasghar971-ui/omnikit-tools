...
| SEO | Per-tool meta/canonical/OG, `WebApplication` + `FAQPage` + `BreadcrumbList` JSON-LD, drip-feed sitemap |
...
| i18n | 9 Tier-1 locales: EN · ES · DE · FR · PT · JA · ZH-CN · ZH-TW · AR (RTL) |
